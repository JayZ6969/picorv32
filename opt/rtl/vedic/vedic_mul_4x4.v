...
vedic_mul_2x2 #(.WIDTH(HALF)) u_ll (.A(A[HALF-1:0]),      .B(B[HALF-1:0]),      .P(P_LL));
vedic_mul_2x2 #(.WIDTH(HALF)) u_lh (.A(A[HALF-1:0]),      .B(B[WIDTH-1:HALF]),  .P(P_LH));
vedic_mul_2x2 #(.WIDTH(HALF)) u_hl (.A(A[WIDTH-1:HALF]),  .B(B[HALF-1:0]),      .P(P_HL));
vedic_mul_2x2 #(.WIDTH(HALF)) u_hh (.A(A[WIDTH-1:HALF]),  .B(B[WIDTH-1:HALF]),  .P(P_HH));
